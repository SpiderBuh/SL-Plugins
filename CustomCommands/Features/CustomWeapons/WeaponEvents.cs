...
//			{
//				if (plr.TemporaryData.Contains("flauncher") && CustomCommandsPlugin.Config.EnableFlashbangLauncher)
//				{
...
//				}
//				else if (plr.TemporaryData.Contains("glauncher") && CustomCommandsPlugin.Config.EnableGrenadeLauncher)
//				{
...
//				}
//				else if (plr.TemporaryData.Contains("blauncher") && CustomCommandsPlugin.Config.EnableBallLauncher)
//				{
...
//				else if (plr.TemporaryData.Contains("rdlauncher") && CustomCommandsPlugin.Config.EnableRagdollLauncher)
//				{
...
//			if (CustomCommandsPlugin.Config.EnableTranqGun && ItemManager.TranqGunSet)
//			{
...
//		{
//			if (CustomCommandsPlugin.Config.EnableTranqGun)
//			{
...
//					Logger.Info($"SELECTED Location: {selectedItem.Position} {selectedItem.NetworkInfo.Serial}");
