...
public class Unpause : ICustomCommand
{
    public string Command => "unpause";

    public string[] Aliases => ["resume"];

    public string Description => "Un-pauses a speaker toy.";
    ...
    public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response)
    {
        ...
        response = "THe thingy hgas been unpaused";
        return true;
    }
}